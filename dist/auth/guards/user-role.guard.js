...
let UserRoleGuard = class UserRoleGuard {
    ...
    canActivate(context) {
        const validRoles = this.reflector.get(role_protected_decorator_1.META_ROLE, context.getHandler());
        if (!validRoles)
            return true;
        ...
        throw new common_1.ForbiddenException(`User ${user.fulName} need a valid role [${validRoles}]`);
